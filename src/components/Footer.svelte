<footer
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> dzl2@njit.edu</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/DanielLobo2025" target="_blank" class="text-violet-400"
                >DanielLobo2025<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/csdaniellobo/" target="" class="text-violet-400"
                >Daniel Lobo<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
